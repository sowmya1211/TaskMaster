...
const Topbar = ({fullname,username,group_name,setActiveComponent}) => {
    ...
    return (
        <div className='container flex flex-row justify-between absolute top-0 right-0 h-[10%] w-[80%] z-10 bg-[#d9d9d9]'>
          <div onClick={() => setActiveComponent('maintaskdashboard')} className="cursor-pointer absolute left-30 p-4 flex flex-row items-center text-3xl text-gray-blue transition-opacity duration-300 ease-in-out hover:opacity-50  "> TASK PAGE </div>
